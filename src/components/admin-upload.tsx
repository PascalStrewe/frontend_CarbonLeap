...
import { Upload, FileText, AlertCircle, CheckCircle2, X, Eye, Save, Download } from 'lucide-react';
...
const AdminUpload = () => {
      ...
      try {
        ...
        const record = {
          ...
          additionality: columnIndices.additionality !== -1 
            ? values[columnIndices.additionality]?.toLowerCase() === 'yes'
            : false,
          causality: columnIndices.causality !== -1 
            ? values[columnIndices.causality]?.toLowerCase() === 'yes'
            : false,
          status: 'Verified'
        };
  ...
  const processFile = useCallback((file) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        addInterventions(data); // Add this line to update the shared state
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <h1 className="text-2xl font-bold text-[#103D5E] mb-6">Upload Intervention Data</h1>
      ...
      {preview.length > 0 && (
        <div className="mt-8 bg-white/25 backdrop-blur-md rounded-lg p-6 border border-white/20">
        ...
        <div className="mt-8 bg-white/25 backdrop-blur-md rounded-lg p-6 border border-white/20">
          ...
          <div className="mt-6 flex justify-end">
            <button
              ...
              className="flex items-center gap-2 bg-[#103D5E] text-white px-4 py-2 rounded-lg hover:bg-[#103D5E]/90 transition-colors"
            >
